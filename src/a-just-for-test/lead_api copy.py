...
from llm_factory.llm_helper import get_llm_modal_with_tools, get_grog_llm, acidaes_llm, get_llm_mixtral
...
#mod
# el = get_grog_llm(tools)
#model = acidaes_llm(tools)
model = get_llm_mixtral(tools)
